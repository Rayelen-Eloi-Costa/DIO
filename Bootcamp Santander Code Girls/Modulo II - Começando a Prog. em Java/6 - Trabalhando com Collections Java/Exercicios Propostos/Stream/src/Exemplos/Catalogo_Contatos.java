...
import Exercicio_Proposto_03.Contato;
...
public class Catalogo_Contatos {

	public static void main(String[] args) {
        System.out.println("--\t Ordem aleatória \t--");
        Map<Integer, Contato> agenda = new HashMap<>() {{
           put(1, new Contato("Simba Lion", 5555));
           put(4, new Contato("Camila Cavalcante", 1111));
           put(3, new Contato("Jonh Souza", 2222));
        }};
